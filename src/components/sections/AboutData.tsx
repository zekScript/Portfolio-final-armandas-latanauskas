...
const AboutData = () => {
  return (
    <div className='w-[500px]'>
          ...
          <button><a href='random.pdf' download="/files/resume.pdf"><span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
